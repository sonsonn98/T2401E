...
class App{
    private $controller, $action, $params, $conn, $controllerpath, $authmiddleware;    

    public function __construct($_conn,  AuthMiddleware $middleware){
    ...
    public function getPath(){
        ...
        return $_SERVER['PATH_INFO'];
            ...
            return null; //lát sửa lại thành redirect về trang home
        }
    }
    ...
    public function handleUrl(){
        ...
        if(method_exists($this->controllerpath, $this->action)){
            $this -> authmiddleware->execute($this->controller, $this->action);
